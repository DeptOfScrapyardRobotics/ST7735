...
namespace ScrapyardIO\Libraries\Displays\Drivers\ST7735\Enums\CommandRegister;

enum ST7735CommandRegister: int
{
    case NO_OP = 0x00;
    ...
    case INVERSION_OFF  = 0x20;
    case INVERSION_ON  = 0x21;

    case GAMMA_CURVE_SELECT  = 0x26;
    ...
    case WRITE_RGB_LUT = 0x2D;
    case PARTIAL_ADDRESS_SET = 0x30;
    case SCROLL_AREA_SET = 0x33;
    case TEARING_LINE_EFFECT_OFF = 0x34;
    case TEARING_LINE_EFFECT_ON = 0x35;

    case MEMORY_ACCESS_CONTROL = 0x36;
    case SCROLL_START_ADDRESS = 0x37;
    ...
    case GATE_PUMP_CLOCK_FREQ = 0xFC;                   // Power control 6 partial+idle (+ 1 byte)
