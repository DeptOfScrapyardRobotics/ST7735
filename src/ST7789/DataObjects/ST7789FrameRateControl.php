...
readonly class ST7789FrameRateControl extends DataRegister
{
    public function __construct(
        ...
        if (($this->rtna < 0) || ($this->rtna > 0x1F)) {
            throw ST7789Exception::invalidRegisterValue('rtna', $this->rtna, 0, 0x1F);
        }

        if (($this->inversion_selection < 0) || ($this->inversion_selection > 0x07)) {
            throw ST7789Exception::invalidRegisterValue('inversion_selection', $this->inversion_selection, 0, 0x07);
        }
    }
